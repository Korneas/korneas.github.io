...
var imageList = [
    ...
    "../img/skills/icon/app.svg",
    "../img/skills/icon/art.svg",
    "../img/skills/icon/communication.svg",
    "../img/skills/icon/creative.svg",
    "../img/skills/icon/decision.svg",
    "../img/skills/icon/detail.svg",
    "../img/skills/icon/game.svg",
    "../img/skills/icon/problem.svg",
    "../img/skills/icon/switch.svg",
    "../img/skills/icon/team.svg",
    "../img/skills/icon/ui.svg",
    "../img/skills/icon/ux.svg",
    "../img/skills/icon/web.svg"
];

var projectImageList = [
    //Skills icons
    "../img/tools/adobe_after.png",
    "../img/tools/adobe_xd.png",
    ...
    "../img/tools/figma.png",
    "../img/tools/html5.png",
    "../img/tools/illustrator.png",
    "../img/tools/invision.png",
    "../img/tools/java.png",
    "../img/tools/js.png",
    "../img/tools/marvel_app.png",
    "../img/tools/photoshop.png",
    "../img/tools/processing.png",
    "../img/tools/react.png",
    "../img/tools/sass.png",
    "../img/tools/unity.png",
    "../img/tools/visual_studio.png",
    //Rest of banners
